...
return [
    // Site Configuration
    'site_name' => EnvLoader::get('SITE_NAME', 'HytaBansWeb'),
    'footer_site_name' => EnvLoader::get('FOOTER_SITE_NAME', 'YourServer'),
    ...
    'site_description' => EnvLoader::get('SITE_DESCRIPTION', 'Public interface for viewing Hytale server punishments and bans'),
    ...
    'site_theme_color' => EnvLoader::get('SITE_THEME_COLOR', '#f59e0b'),
    ...
    'site_generator' => EnvLoader::get('SITE_GENERATOR', 'HytaBansWeb'),
    ...
    'show_server_origin' => EnvLoader::get('SHOW_SERVER_ORIGIN', 'false') === 'true',
    'show_server_scope' => EnvLoader::get('SHOW_SERVER_SCOPE', 'false') === 'true',
