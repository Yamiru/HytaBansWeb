...
/**
 * ============================================================================
 *  HytaBansWeb - Secure Password Hash Generator
 * ============================================================================
 *
...
<head>
    <meta charset="UTF-8">
    <title>Password Hash Generator - HytaBansWeb</title>
...
<body>
    <div class="box">
        ...
        <div class="footer">
            &copy; <?= date("Y") ?> HytaBansWeb - built by <a href="https://yamiru.com" target="_blank">Yamiru</a>
        </div>
    </div>
