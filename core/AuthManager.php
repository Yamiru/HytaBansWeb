...
/**
 * ============================================================================
 *  HytaBansWeb - Authentication Manager
 * ============================================================================
 *
 *  Plugin Name:   HytaBansWeb
 *  Description:   Google OAuth and Discord OAuth for admin panel
 *  Version:       1.0
 *  License:       MIT
 * ============================================================================
 */
...
class AuthManager
{
    ...
    {
        // Use BASE_URL from config if set
        $baseUrl = $this->config['base_url'] ?? '';
        
        if (empty($baseUrl)) {
            // Auto-detect base URL from current request
            $protocol = 'https'; // Always use HTTPS for OAuth
        ...
        // Return provider-specific callback URL
        if ($provider === 'discord') {
            return $baseUrl . '/admin/oauth-callback?provider=discord';
        }
        
        return $baseUrl . '/admin/callback/google';
    }
